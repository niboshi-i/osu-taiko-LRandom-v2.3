...
ルールの入力方法　例)2,3,10,2,4　このように半角数字をカンマで区切ってください、この場合だと2連続の配色が40%、3と4と10連続が20%ずつ出ます
...
How to enter rules: Example) 2,3,10,2,4 Separate half-width numbers with commas like this. In this case, 40% of the 2 consecutive color schemes will appear, and 20% each of the 3, 4, and 10 consecutive color schemes will appear.
